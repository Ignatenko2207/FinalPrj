...
public class LessonServiceTest {
	...
	public void testLessonsByGroupAndStartTime() {
		...
		Lesson lessonDB = lessonServiceImpl.saveAndUpdate(lesson);
		assertNotNull(lessonDB);
		List<Lesson> lessonsDBCheck = lessonServiceImpl.getLessonsByGroupAndStartTime(lessonDB.getGroup(),
				lessonDB.getLessonStart());
	...
	public void testGetLessonsByTeacherAndStartTime() {
		...
		Lesson lessonDB = lessonServiceImpl.saveAndUpdate(lesson);
		assertNotNull(lessonDB);
		List<Lesson> lessonsDBCheck = lessonServiceImpl.getLessonsByTeacherAndStartTime(lessonDB.getTeacher(),
				lessonDB.getLessonStart());
		assertNotNull(lessonsDBCheck);
		assertEquals(lessonDB.getLessonStart(), lessonsDBCheck.get(0).getLessonStart());
	...
	public void testGetLessonsForGroupForPeriod() {
		...
		Lesson lessonDB = lessonServiceImpl.saveAndUpdate(lesson);
		assertNotNull(lessonDB);
		List<Lesson> lessonsDBCheck = lessonServiceImpl.getLessonsForGroupForPeriod(lessonDB.getGroup(),
				lessonDB.getLessonStart(), lessonDB.getLessonStart() + lessonDB.getLength());
		assertNotNull(lessonsDBCheck);
	...
	public void testGetLessonsForCourseForPeriod() {
		...
		List<Lesson> lessonsDBCheck = lessonServiceImpl.getLessonsForCourseForPeriod(group.getCourse(),
				lessonDB.getLessonStart(), lessonDB.getLessonStart() + lessonDB.getLength());
		assertNotNull(lessonsDBCheck);
		long lessonDBEnd = (lessonDB.getLessonStart() + lessonDB.getLength());
	...
	public void testGetLessonsForTeacherForPeriod() {
		...
		Lesson lessonDB = lessonServiceImpl.saveAndUpdate(lesson);
		assertNotNull(lessonDB);
		List<Lesson> lessonsDBCheck = lessonServiceImpl.getLessonsForTeacherForPeriod(lessonDB.getTeacher(),
				lessonDB.getLessonStart(), lessonDB.getLessonStart() + lessonDB.getLength());
		assertNotNull(lessonsDBCheck);
		long lessonDBEnd = (lessonDB.getLessonStart() + lessonDB.getLength());
		assertEquals(lessonDB.getTeacher(), lessonsDBCheck.get(0).getTeacher());
